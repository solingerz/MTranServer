...
Options:
  ...
  --max-active-engines     Max number of loaded engines (0 means unlimited, default: 0)
...
Environment Variables:
  ...
  MT_WORKERS_PER_LANGUAGE, MT_MAX_ACTIVE_ENGINES, MT_API_TOKEN, MT_LOG_TO_FILE, MT_LOG_CONSOLE,
